...
class TestTransformPredict(marbles.core.TestCase):
    ...
    # Variable reservada
    __name__ = 'TestTransformPredict'

    def test_transform_predict_delay_positive(self):
        ...
        self.str_NombreMetodo = 'test_transform_predict_delay_positive'
