...
QUIT;
/*Trabajar con las horas para hacer el análisis del Delay*/
...
RUN;
/*Tomar el máximo de por ID_AVION Y FECHA*/
PROC SQL;
...
QUIT;
/*Pegar la tabla de Máximos a la tabla NW4 creando NW5*/
PROC SQL;
	...
	ORDER BY t1.ID_AVION, t1.FECHA, t1.HORASALIDAF;
QUIT;
/*Hacer la resta para obtener el # de vuelos faltantes en el día para el mismo avión*/
PROC SQL;
...
RUN;
/*Borrar el IND_RETRASO2 y crear dominó igualando IND1 vs IND3*/
PROC SQL; 
...
/*RUN;*/
/*Hacer la pregunta de Cuantos retrasos le ocurren al día al avión que genera efecto dominó*/
PROC SQL;
...
PROC SQL;
	...
	ORDER BY t1.ID_AVION, t1.FECHA, t1.HORASALIDAF;
QUIT;
/*Eliminar cuando ocurren dobles o triples efectos dominó*/
PROC SQL;
	...
	ORDER BY t1.ID_AVION, t1.FECHA, t1.HORASALIDAF;
QUIT;
/*Hacer las condicionales para el cálculo de la suma de vuelos afectados*/
...
la cual tiene aquellos días en donde se dan 2 o hasta 3 efectos dominó no consecutivos*/
DATA Rodrigo.NW17;
	SET WORK.NW16;
	COUNT2 + (-1);
	BY ID_AVION FECHA;
